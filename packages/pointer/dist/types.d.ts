 ...
 */
export declare enum PointerEventError {
 ...
 */
export declare class PointerEventHandlerError extends Error {
    readonly type: PointerEventError;
    readonly details: string;
    readonly originalError?: Error | undefined;
    constructor(type: PointerEventError, details: string, originalError?: Error | undefined);
}
